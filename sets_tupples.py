...
# #List has .find, sets do not
# #you canna acces elements by index as sets are unordred
# #instead you can convert the set to a list and acces elements by index
# list1=list(set1)
# print(list1[0])
# #we use sets when we want to store unique elements and we do't care about the order and do not want the elements to change
...
sample_list = [[1, 2, 3], [4, 5, 6], [7, 8, 9]] #nest of lists
...
sample_list_of_fruit = {"fruits": ["apple", "banana", "cherry"]} #list in dictionary
...
print(sample_list_of_lists["lists"][2][1]) #prints 8
print(sample_list_of_lists["lists"][0][2]) #prints 3
print(sample_list_of_lists["lists"][2][0]) #prints 7


sample_list_of_dicts = {"dicts": [{"name": "Alice", "age": 25}, {"name": "Bob", "age": 30}, {"name": "Charlie", "age": 35}]} #nest of lists of dictionaries
...
total_budget = (company["departments"]["Engineering"]["budget"]) + (company["departments"]["HR"]["budget"])
print(total_budget)
